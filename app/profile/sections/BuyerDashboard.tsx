  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        ...
        <div className="space-y-4">
          {/* 주문 내역 */}
          <Card className="p-4 cursor-pointer hover:bg-muted/50 transition-colors" onClick={() => router.push('/orders')}>
          ...
          {/* 작성한 리뷰 */}
          <Card className="p-4 cursor-pointer hover:bg-muted/50 transition-colors" onClick={() => router.push('/reviews')}>
            <div className="flex items-center gap-3">
        ...
        <div className="space-y-4">
          {/* 찜한 상품 */}
          <Card className="p-4 cursor-pointer hover:bg-muted/50 transition-colors" onClick={() => router.push('/wishlist')}>
            <div className="flex items-center gap-3">
